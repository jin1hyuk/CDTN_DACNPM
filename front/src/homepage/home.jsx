...
const DigiForum: React.FC = () => {
    const handleNotificationClick = () => alert('Notification clicked!');
    const handleChatClick = () => alert('Chat clicked!');
        ...
        <div>
            <nav className="navbar navbar-expand-lg navbar-dark bg-success">
                ...
                <div className="notification-icons">
                    <a href="#" onClick={handleNotificationClick}>🔔</a>
                    <a href="#" onClick={handleChatClick}>💬</a>
                </div>
            </nav>
